...
Students are required to used core dataset of West Midlands Police from https://data.police.uk/data/ from December 2023 to November 2025 (Check only "Include crime data") by utilisating Python coding techniques to provide key findings through stats and visualisation, the business case should be aimed at helping a non-technical stakeholder (e.g., a Police Commissioner) in understanding crime insights and decision making
